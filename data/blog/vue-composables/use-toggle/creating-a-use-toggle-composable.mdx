---
title: Building an Event Driven useToggle Composable With Vue and TypeScript
date: 2023-04-07T15:32:14Z
lastmod: '2023-04-11'
tags: ['vue.js', 'composables', 'utility']
draft: false
...
Okay, let's start by scaffolding our `useToggle` composable.
...
Nice. We have our inputs and outputs ready to go. Let's start build the logic for our register functions.
...
- Accept a callback and options, and call the subscribe function with the correct callbacks to push our subscription onto.
...
Our goal here is to watch for changes on our `booleanValue` variable, and trigger the relevant callback upon these changes. Let's create a `triggerCallbacks` function to handle triggering callbacks.
...
In an upcoming post, we'll put this composable to work. Stay tuned!
