...
## Overview
In a [recent article](http://localhost:3000/blog/web3/web3-providers-explained), I highlighted the necessity of web3 providers when constructing a web3 application. Now that we comprehend the necessities, let's move forward to start building our web3 toolkit. Our first step will be to establish a connection to a provider. Let's get to it!
